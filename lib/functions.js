 ...
 */
exports.getOsxWindowHeader = ( width, title = 'running code' ) => {
    return `
 ...
 * @returns { string } - SVG string
 */
exports.getExecutionResultInTerminalWindow = ( svg, width ) => {
    ...
    return `
        <svg viewBox="0, 0, ${ width }, ${ svgHeight }">
            ...
            <rect x="0" y="0" width="${ width }" height="1" fill="#666666" />
            
            <g>
                <!-- head -->
                <g font-family="monospace" font-size="14">
                    <rect x="0" y="1" width="${ width }" height="30" fill="#222222" />
                    <text x="30" y="20" fill="#FFFFFF">TERMINAL</text>
                </g>
